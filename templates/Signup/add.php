...
<body>
	    ...
	    <main class="main">
	    <?= $this->Form->create($user, [ 'class' => 'form-horizontal', 'controller' => 'Signup', 'action' => 'add']); ?>
	            ...
	            <div class="form-content">
	                <div class="row">	                	
	                    <div class="col-md-6">	                    	
	                        ...
	                        <?php /* <div class="form-group <?= isset($user->getErrors()['name']) ? 'has-error' : '' ?>">	                        	
	                    ...
	                    <div class="col-md-6">
	                    	...
	                    	<?= $this->Form->control('confirm', ['type' => 'password']) ?>
	                    	<?php /*
	                        ...
	                        <div class="form-group <?= isset($user->getErrors()['confirm']) ? 'has-error' : '' ?>">
	                            <input type="password" name="confirm" class="form-control" placeholder="Confirm Password *" value="<?= $user['confirm'] ?>"/>
	                        </div>
	                        */
	                        ?>
	                    </div>
